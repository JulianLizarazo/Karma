...
var VehicleDetaileModel = require('../modelos/vehicledetailmodel.js');
...
module.exports = function (){
    ...
    router.get("/", function (req, res){
        ...
        VehicleDetaileModel.getVehicleDetails(function (error, data){
    ...
    router.get("/:id", function (req, res){
        ...
        if (!isNaN(id)){
            VehicleDetaileModel.getVehicleDetail(id, function (error, data){
    ...
    router.post("/", function (req, res){
        ...
        VehicleDetaileModel.insertVehicleDetail(VehicleDetailData, function (error, data){
    ...
    router.put("/", function (req, res){
        ...
        VehicleDetaileModel.updateVehicleDetail(VehicleDetailData, function (error, data){
            //se muestra el mensaje correspondiente
            if (data && data.msg){
                res.status(200).json(data);
            }else{

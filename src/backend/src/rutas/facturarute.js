...
var ModeloFactura = require('../modelos/facturamodel.js');
...
module.exports = function (){
    ...
    router.get("/", function (req, res){
        ...
        ModeloFactura.getFacturas(function (error, data){
    ...
    router.get("/:id", function (req, res){
        ...
        if (!isNaN(id)){
            ModeloFactura.getFactura(id, function (error, data){
    ...
    router.post("/", function (req, res){
        ...
        ModeloFactura.insertFactura(FacturaData, function (error, data){
    ...
    router.put("/:id", function (req, res){
        ...
        ModeloFactura.updateFactura(FacturaData, function (error, data){
            //se muestra el mensaje correspondiente
            if (data && data.msg){
                res.status(200).json(data);
            }else{

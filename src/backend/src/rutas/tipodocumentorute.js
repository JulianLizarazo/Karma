...
var TipoDocumentoModel = require('../modelos/tipodocumentomodel.js');
...
module.exports = function (){
    ...
    router.get("/", function (req, res){
        ...
        TipoDocumentoModel.getDocumentos(function (error, data){
    ...
    router.get("/:id", function (req, res){
        ...
        if (!isNaN(id)){
            TipoDocumentoModel.getDocumento(id, function (error, data){
    ...
    router.post("/", function (req, res){
        ...
        TipoDocumentoModel.insertDocumento(TipoDocumentoData, function (error, data){
    ...
    router.put("/:id", function (req, res){
        ...
        TipoDocumentoModel.updateDocumento(TipoDocumentoData, function (error, data){
            //se muestra el mensaje correspondiente
            if (data && data.msg){
                res.status(200).json(data);
            }else{

...
var InvoiceModel = require('../modelos/invoicemodel.js');
...
module.exports = function (){
    ...
    router.get("/", function (req, res){
        ...
        InvoiceModel.getInvoices(function (error, data){
    ...
    router.get("/:id", function (req, res){
        ...
        if (!isNaN(id)){
            InvoiceModel.getInvoice(id, function (error, data){
    ...
    router.post("/", function (req, res){
        ...
        InvoiceModel.insertInvoice(InvoiceData, function (error, data){
    ...
    router.put("/:id", function (req, res){
        ...
        InvoiceModel.updateInvoice(InvoiceData, function (error, data){
            //se muestra el mensaje correspondiente
            if (data && data.msg){
                res.status(200).json(data);
            }else{

...
var SedeModel = require('../modelos/sedemodel.js');
...
module.exports = function (){
    ...
    router.get("/", function (req, res){
        ...
        SedeModel.getSedes(function (error, data){
    ...
    router.get("/:id", function (req, res){
        ...
        if (!isNaN(id)){
            SedeModel.getSede(id, function (error, data){
    ...
    router.post("/", function (req, res){
        ...
        SedeModel.insertSede(SedeData, function (error, data){
    ...
    router.put("/:id", function (req, res){
        ...
        SedeModel.updateSede(SedeData, function (error, data){
            //se muestra el mensaje correspondiente
            if (data && data.msg){
                res.status(200).json(data);
            }else{

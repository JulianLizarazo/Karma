...
INSERT INTO `document_type` (`id_document`, `document`) VALUES
(1, 'Cedula Extranjero'),
...
INSERT INTO `invoice` (`id_invoice`, `VAT`, `payment_method`, `date`, `id_user`, `id_campus`, `price`) VALUES
(1, 0.19, 'Tarjeta Debito', '2021-11-14', 1, 1, '15000.00'),
(2, 0.19, 'Tarjeta Credito', '2019-05-02', 2, 3, '12500.00'),
(3, 0.19, 'Cheque', '2017-03-10', 3, 2, '16000.00'),
(4, 0.19, 'Efectivo', '2020-08-09', 4, 1, '10000.00'),
(5, 0.19, 'Tarjeta Credito', '2021-01-12', 5, 2, '20000.00');
...
INSERT INTO `invoice_detail` (`id_invoice_det`, `amount`, `id_vehicle_detail`, `id_invoice`) VALUES
(1, 1, 1, 1),
(2, 1, 2, 2),
(3, 1, 3, 3),
(4, 1, 4, 4),
...
(1, 'Juan', 'Pablo', 'Wilches', 'Espinosa', 'juanpablo@hotmail.com', '3057245010', 2, '1018514704'),
...
--
ALTER TABLE `vehicle`
  MODIFY `id_vehicle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

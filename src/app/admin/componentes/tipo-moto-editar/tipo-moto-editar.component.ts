...
@Component({
  selector: 'app-tipo-moto-editar',
  templateUrl: './tipo-moto-editar.component.html',
  styleUrls: ['./tipo-moto-editar.component.scss'],
})
export class VehicleTypeEditComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    this.vehicleTypeService
      .updateVehicleType(this.id, newVehicleType)
      .subscribe((prueba) => {
        console.log(prueba);
      });

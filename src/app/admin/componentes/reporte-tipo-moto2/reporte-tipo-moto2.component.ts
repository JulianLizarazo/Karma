...
import { ReportVehicleType2Service } from '../../../nucleo/services/reporte-tipo-moto-2/reporte-tipo-moto2.service';

import { VehicleType2 } from 'src/app/nucleo/models/tipoMoto2.model';
import { VehicleTypeService } from 'src/app/nucleo/services/tipo-moto/tipo-moto.service';

@Component({
  selector: 'app-reporte-tipo-moto2',
  templateUrl: './reporte-tipo-moto2.component.html',
  styleUrls: ['./reporte-tipo-moto2.component.scss'],
})
export class ReportVehicleType2Component implements OnInit {
  ...
  onSubmit(): void {
    this.reportVehicleType2Service

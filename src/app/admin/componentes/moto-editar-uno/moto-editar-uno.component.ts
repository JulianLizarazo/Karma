...
@Component({
  selector: 'app-moto-editar-uno',
  templateUrl: './moto-editar-uno.component.html',
  styleUrls: ['./moto-editar-uno.component.scss'],
})
export class VehicleEditSingleComponent implements OnInit {
  ...
  onSubmit(): void {
    this.vehicleService
      .getVehicle(this.addressForm.controls.statesId.value)
      .subscribe((vehicle) => {
